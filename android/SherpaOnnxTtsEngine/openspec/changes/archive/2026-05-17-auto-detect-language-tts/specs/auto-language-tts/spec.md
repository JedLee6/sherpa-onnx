...
When using the `supertonic-3-tts` model, input text containing multiple sentences of different languages MUST be pronounced correctly by automatically switching the engine's language configuration for each sentence.
...
- **THEN** the text should be split into "Hello world." and "你好世界。".
